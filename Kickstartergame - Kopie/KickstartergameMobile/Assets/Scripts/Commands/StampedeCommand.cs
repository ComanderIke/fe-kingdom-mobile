...
namespace Assets.Scripts.Commands
{
    class StampedeCommand : Command
    {
        ...
        public override void Execute()
        {
            ...
            while (!MainScript.GetInstance().gridManager.GridLogic.IsBigTileAccessible(endPosition, unit) && index >= 0);
            Debug.Log("EndPosition: " + endPosition);
            if (MainScript.GetInstance().gridManager.GridLogic.IsBigTileAccessible(endPosition, unit))
            {
