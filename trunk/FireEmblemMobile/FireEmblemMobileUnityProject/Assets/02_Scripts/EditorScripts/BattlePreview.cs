...
public class BattlePreviewWindow : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		EditorGUILayout.PropertyField(attackerLevel, new GUIContent("Level"),GUILayout.Height(20), GUILayout.Width(100));//, GUILayout.ExpandWidth(false));
		...
		// }
		 EditorGUILayout.PropertyField(defenderLevel, new GUIContent("Level"),GUILayout.Height(20), GUILayout.Width(100));
		...
		EditorGUILayout.PropertyField(attackerDamage, new GUIContent("Damage"),GUILayout.Height(20), GUILayout.Width(100));
		EditorGUILayout.PropertyField(attackerHit, new GUIContent("Hit"),GUILayout.Height(20), GUILayout.Width(100));
		EditorGUILayout.PropertyField(attackerCrit, new GUIContent("Crit"),GUILayout.Height(20), GUILayout.Width(100));
		EditorGUILayout.PropertyField(attackerAttackSpeed, new GUIContent("AS"),GUILayout.Height(20), GUILayout.Width(100));
		
		
		GUILayout.EndVertical();
		GUILayout.BeginVertical();
		EditorGUILayout.PropertyField(defenderHp, new GUIContent("Hp"),GUILayout.Height(20), GUILayout.Width(100));
		EditorGUILayout.PropertyField(defenderDamage, new GUIContent("Damage"),GUILayout.Height(20), GUILayout.Width(100));
		EditorGUILayout.PropertyField(defenderHit, new GUIContent("Hit"),GUILayout.Height(20), GUILayout.Width(100));
		EditorGUILayout.PropertyField(defenderCrit, new GUIContent("Crit"),GUILayout.Height(20), GUILayout.Width(100));
		EditorGUILayout.PropertyField(defenderAttackSpeed, new GUIContent("AS"),GUILayout.Height(20), GUILayout.Width(100));
