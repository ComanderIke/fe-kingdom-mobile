...
{
    [System.Serializable]
    ///[CreateAssetMenu(menuName = "BattlePreviewForEditorSO")]
    public class BattlePreviewForEditor
    {
        ...
        public void OnValidate()
        {
            ...
            int scaledHP = (int)( attacker.stats.BaseAttributes.MaxHp + (attacker.stats.BaseGrowths.MaxHp*2 * attackerLevel)/100f);
            ...
            int scaledDefenderHP = (int)( defender.stats.BaseAttributes.MaxHp + (defender.stats.BaseGrowths.MaxHp*2 * defenderLevel)/100f);
