...
// ... your box content ...
                   ...
                   // EditorGUILayout.PropertyField(transformProp);
                    ...
                    switch (lineTypeProp.enumValueIndex)
                    {
                        ...
                        case (int)LineType.MultipleChoice:
                            var optionsProp = transformProp.FindPropertyRelative("options");
                            EditorGUILayout.PropertyField(optionsProp);break;
                        case (int)LineType.YesNoChoice: break;
                    } 
