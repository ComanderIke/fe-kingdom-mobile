...
namespace LeanTween.Examples.Scripts
{
    public class TestingZLegacyExt : MonoBehaviour {
        ...
        public void updateValue3Example()
        {
            ...
            gameObject.LeanValue( updateValue3ExampleCallback, new Vector3(0.0f, 270.0f, 0.0f), new Vector3(30.0f, 270.0f, 180f), 0.5f).setEase(Framework.LeanTweenType.easeInBounce).setRepeat(2).setLoopPingPong().setOnUpdateVector3(updateValue3ExampleUpdate).setUseEstimatedTime(useEstimatedTime);
        }
        ...
        public void loopTestClamp()
        {
            ...
            cube1.LeanScaleZ( 4.0f, 1.0f).setEase(Framework.LeanTweenType.easeOutElastic).setRepeat(7).setLoopClamp().setUseEstimatedTime(useEstimatedTime);//
        }
        ...
        public void loopTestPingPong()
        {
            ...
            cube2.LeanScaleY( 4.0f, 1.0f).setEase(Framework.LeanTweenType.easeOutQuad).setLoopPingPong(4).setUseEstimatedTime(useEstimatedTime);
        ...
        public void colorExample()
        {
            ...
            lChar.LeanColor( new Color(1.0f, 0.0f, 0.0f, 0.5f), 0.5f).setEase(Framework.LeanTweenType.easeOutBounce).setRepeat(2).setLoopPingPong().setUseEstimatedTime(useEstimatedTime);
        }
        ...
        public void moveOnACurveExample()
        {
            ...
            ltLogo.LeanMove( path, 1.0f).setEase(Framework.LeanTweenType.easeOutQuad).setOrientToPath(true).setUseEstimatedTime(useEstimatedTime);
        }
        ...
        public void rotateExample()
        {
            ...
            ltLogo.LeanRotate(new Vector3(0f, 360f, 0f), 1f).setEase(Framework.LeanTweenType.easeOutQuad).setOnComplete(rotateFinished).setOnCompleteParam(returnParam).setOnUpdate(rotateOnUpdate).setUseEstimatedTime(useEstimatedTime);
        }
        ...
        public void scaleExample()
        {
            ...
            ltLogo.LeanScale(new Vector3(currentScale.x + 0.2f, currentScale.y + 0.2f, currentScale.z + 0.2f), 1f).setEase(Framework.LeanTweenType.easeOutBounce).setUseEstimatedTime(useEstimatedTime);
        }
        ...
        public void updateValueExample()
        {
            ...
            pass.Add("message", "hi");
            gameObject.LeanValue( (Action<float, object>)updateValueExampleCallback, ltLogo.eulerAngles.y, 270f, 1f).setEase(Framework.LeanTweenType.easeOutElastic).setOnUpdateParam(pass).setUseEstimatedTime(useEstimatedTime);
        }
        ...
        public void delayedCallExampleCallback()
        {
            ...
            ltLogo.LeanScale( new Vector3(currentScale.x - 0.2f, currentScale.y - 0.2f, currentScale.z - 0.2f), 0.5f).setEase(Framework.LeanTweenType.easeInOutCirc).setUseEstimatedTime(useEstimatedTime);
        }
        ...
        {
            ltLogo.LeanMoveX(7.0f, 1.0f).setEase(Framework.LeanTweenType.punch).setUseEstimatedTime(useEstimatedTime);
        }
    }
}
