...
namespace LeanTween.Examples.Scripts
{
    ...
    public class TestingUnitTests : MonoBehaviour
    {
        ...
        private int lt1Id;
        private Framework.LTDescr lt2;
        private Framework.LTDescr lt3;
        private Framework.LTDescr lt4;
        private Framework.LTDescr[] groupTweens;
        ...
        void Start()
        {
            ...
            Framework.LeanTween.delayedCall(cubes[0], 0.2f, () => {
                for (int i = 0; i < cubes.Length; i++)
                {
                    ...
                    {
                        Framework.LTDescr descr = Framework.LeanTween.descr(tweenIds[i]);
            ...
            Framework.LTSpline cr = new Framework.LTSpline(splineArr);
            ...
            Framework.LeanTween.move(cubeToTrans, cubeDest.transform, 1.2f).setEase(Framework.LeanTweenType.easeOutQuad).setOnComplete(() => {
            ...
            Framework.LeanTween.delayedCall(gameObject, 0.2f, () => {
                Framework.LTDescr d = Framework.LeanTween.descr(jumpTimeId);
            ...
            for (int j = 0; j < 2; j++)
            {
                ...
                int totalTweenTypeLength = (int)Framework.LeanTweenType.easeShake;
                for (int i = (int)Framework.LeanTweenType.notUsed; i < totalTweenTypeLength; i++)
                {
                    Framework.LeanTweenType easeType = (Framework.LeanTweenType)i;
                    GameObject cube = cubeNamed("cube" + easeType);
                    Framework.LTDescr descr = Framework.LeanTween.moveLocalX(cube, 5, 0.1f).setOnComplete((object obj) => {
        ...
        IEnumerator timeBasedTesting()
        {
            ...
            Framework.LTDescr[] descr = Framework.LeanTween.descriptions(cubeNormal);
            ...
            Framework.LTBezierPath roundCircPath = new Framework.LTBezierPath(roundCirc);
            ...
            groupTweens = new Framework.LTDescr[1200];
        ...
        void eventGameObjectCalled(Framework.LTEvent e)
        {
            eventGameObjectWasCalled = true;
        }

        void eventGeneralCalled(Framework.LTEvent e)
        {
